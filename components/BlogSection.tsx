...
export default function BlogSection({ blogs }: BlogSectionProps) {
    ...
    return (
        <section className="py-20 md:py-28 bg-white dark:bg-slate-950 relative">
            <div className="dynamic-container">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                    {safeBlogs.slice(0, 3).map((blog, index) => (
                        <Link
                            ...
                            key={blog?.id || index}
                            className="group bg-slate-50 dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 hover:border-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-500 flex flex-col"
                        >
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                <div className="flex items-center gap-4 text-xs text-slate-500 mb-4">
                                 ...
                                 <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-cyan-400 transition-colors line-clamp-2">
                ...
                <div className="text-center">
                    <Link
                        href="/blog"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-slate-50 dark:bg-slate-900 hover:bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold rounded-xl border border-slate-200 dark:border-slate-800 hover:border-cyan-500/50 transition-all group"
                    >
                        View All Articles
