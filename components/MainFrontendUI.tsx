    ...
    return (
        <>
            ...
            <div className={cn(
                ...
                isAdminPage ? "pt-0" : (pathname === "/" || pathname === "/gallery" || pathname === "/services" || pathname === "/features" || pathname === "/blog" || pathname === "/contact" || pathname === "/index.html" || pathname === "" ? "pt-[112px]" : "pt-0")
            )}>
                {children}
            </div>
            <ScrollToTop />
