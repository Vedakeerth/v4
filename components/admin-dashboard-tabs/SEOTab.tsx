...
export default function SEOTab() {
    ...
    if (isLoading) return <div className="text-slate-900 dark:text-white p-8">Loading SEO settings...</div>;
                        ...
                        <div className="grid gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-slate-900 dark:text-white text-sm focus:border-cyan-500/50 transition-all outline-none"
                                />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-2.5 text-slate-900 dark:text-white text-sm focus:border-cyan-500/50 transition-all outline-none h-20 resize-none"
                                />
                            </div>
                        </div>
                    </div>
