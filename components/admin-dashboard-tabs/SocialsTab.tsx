    ...
    return (
        <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 w-full">
            ...
            <div className="space-y-4">
                ...
                <button
                    onClick={handleSave}
                    className="w-full py-4 mt-6 bg-cyan-500 text-white dark:text-slate-950 font-bold rounded-xl shadow-lg shadow-cyan-500/20 hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2"
                >
                    <Save size={20} />
                    Update Social Links
                </button>
