            ...
            {isCartOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={handleClose}
                        className="fixed inset-0 bg-white dark:bg-slate-950/60 backdrop-blur-sm z-[100]"
                    />
                    ...
                    >
                        ...
                        <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
                            ...
                            >
                                <X className="w-6 h-6 text-slate-600 dark:text-slate-400 group-hover:text-white transition-colors" />
                            </button>
                        </div>
                                ...
                                <>
                                    ...
                                    <div className="space-y-4">
                                        {items.map((item) => (
                                            ...
                                            >
                                                {/* Image */}
                                                <div className="relative w-20 h-20 rounded-xl overflow-hidden bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex-shrink-0 group-hover:border-slate-300 dark:border-slate-700 transition-colors">
                                                    <Image
                                                        src={item.image}
                                                        alt={item.name}
                                                        fill
                                    ...
                                    <div className="pt-4 border-t border-slate-200 dark:border-slate-800/50">
                                        <div className="flex items-center gap-2 mb-3">
                                            ...
                                            <span className="text-[10px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest">Apply Coupon Code</span>
                                        </div>
                                        ...
                                        {!appliedCoupon ? (
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-xs font-bold text-white focus:outline-none focus:border-cyan-500/50 transition-all uppercase tracking-widest"
                                                />
                                                <button
                                                    onClick={handleApplyCoupon}
                                                    disabled={isValidating || !couponInput}
                                                    className="px-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 disabled:opacity-50 text-white font-black text-[10px] uppercase tracking-widest rounded-xl transition-all border border-slate-300 dark:border-slate-700"
                                                >
                        ...
                        {/* Footer / Summary */}
                        {items.length > 0 && (
                            <div className="p-6 bg-white dark:bg-slate-950/50 border-t border-slate-200 dark:border-slate-800 space-y-4 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
