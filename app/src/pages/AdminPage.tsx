...
import { LogOut, LayoutGrid, Package, MessageSquare, Globe, Share2, Settings, Briefcase, FileText, Ticket, ShoppingBag, ChevronLeft, ChevronRight, ChevronDown, Home } from "lucide-react";
...
type TabType = "home" | "products" | "projects" | "testimonials" | "blogs" | "seo" | "socials" | "settings" | "features" | "industries" | "coupons" | "orders" | "users" | "categories" | "quote-settings" | "navigation" | "offline-quote";
...
export default function SecureAdminPage() {
    ...
    useEffect(() => {
        const unsubscribe = onAuthStateChanged(auth, async (firebaseUser) => {
            if (!firebaseUser) {
                navigate("/secure-management-portal/login");
            } else {
                ...
                if (!firebaseUser.email?.toLowerCase() || !adminEmails.includes(firebaseUser.email.toLowerCase())) {
                    ...
                    navigate("/secure-management-portal/login?error=AccessDenied");
                } else {
