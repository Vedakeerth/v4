...
function SuccessContent() {
    ...
    return (
        <main className="min-h-screen bg-white dark:bg-slate-950 pt-32 pb-12 flex flex-col items-center">
            <div className="container mx-auto px-4 max-w-2xl">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-12 text-center shadow-2xl relative overflow-hidden"
                >
                    ...
                    {status === 'success' && (
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                                ...
                                <Link
                                    href="/catalog"
                                    className="px-10 py-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-white font-black rounded-2xl transition-all uppercase tracking-widest text-sm"
                                >
                                    Continue Shopping
                                </Link>
                            </div>
                    ...
                    {status === 'failed' && (
                        <div className="space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                                <Link
                                    href="/checkout"
                                    className="px-8 py-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-white font-bold rounded-xl transition-all"
                                >
                                    Try Again
                                </Link>
                                <Link
                    ...
                    {status === 'error' && (
                        <div className="space-y-6">
                            <div className="w-20 h-20 bg-slate-100 dark:bg-slate-800 rounded-full flex items-center justify-center mx-auto border border-slate-300 dark:border-slate-700">
                            ...
                            <Link
                                href="/"
                                className="inline-block px-10 py-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-700 text-white font-black rounded-2xl transition-all uppercase tracking-widest text-sm"
                            >
                                Return Home
                            </Link>
                        </div>
