                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center mb-1.5 ml-1">
                                    ...
                                    <div className="flex items-center gap-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-lg p-1">
                                        ...
                                        }} title="Insert Image" className="p-1.5 hover:bg-slate-100 dark:bg-slate-800 rounded text-slate-600 dark:text-slate-400"><imgIcon size={14} /></button>
                                    </div>
                                </div>
                                <textarea
                        ...
                        <div className="prose prose-invert max-w-none">
                            ...
                            {image && (
                                <div className="relative h-64 w-full mb-6 rounded-xl overflow-hidden">
                                    <img src={image} alt="Cover" fill className="object-cover" />
                                </div>
                            )}
                ...
                {blogs.map(blog => (
                    <div key={blog.id} className="bg-slate-50 dark:bg-slate-900 shadow-xl border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden group hover:border-cyan-500/30 transition-all">
                        <div className="relative h-48 bg-slate-100 dark:bg-slate-800">
                            <img src={blog.image || "/placeholder.png"} alt={blog.title} fill className="object-cover" />
